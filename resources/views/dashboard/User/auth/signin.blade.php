								...
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
											...
											<div class="main-signup-header">
												...
												<div class="form-group">
													...
													<select class="form-control" id="exampleFormControlSelect1">
													  <option value="" selected disabled>اختار نوعية الدخول</option>
													  <option value="user">الدخول كمريض</option>
													  <option value="admin">الدخول كادمن</option>
													</select>
												  </div>
												  {{-- form for user --}} 
									<div class="loginform" id="user">
												...
												<form method="POST" action="{{ route('login.user') }}">
													@csrf
													<div class="form-group">
														<label>Email</label> <input  id="email" name="email" class="form-control" placeholder="Enter your email" type="email" :value="old('email')" required autofocus autocomplete="username">
													</div>
